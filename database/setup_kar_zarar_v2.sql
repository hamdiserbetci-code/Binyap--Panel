...
ALTER TABLE kar_zarar ADD COLUMN IF NOT EXISTS satis_faturalari NUMERIC(14,2) DEFAULT 0;
ALTER TABLE kar_zarar ADD COLUMN IF NOT EXISTS malzeme_alis NUMERIC(14,2) DEFAULT 0;
ALTER TABLE kar_zarar ADD COLUMN IF NOT EXISTS alis_faturalari NUMERIC(14,2) DEFAULT 0;
