-- Eski E-Fatura ve Cari Hesaplar tablolarını sistemden tamamen kaldırıyoruz
DROP TABLE IF EXISTS cari_hareketler CASCADE;
DROP TABLE IF EXISTS cari_hesaplar CASCADE;
DROP TABLE IF EXISTS efatura_kayitlari CASCADE;

-- Yeni Dönemsel Alışlar Tablosu
CREATE TABLE donemsel_alislar (
    ...
    tevkifat_turu TEXT DEFAULT 'yok', -- yok, 2/10, 5/10
