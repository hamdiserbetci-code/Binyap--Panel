...
type Gorev = { id: string; baslik: string; aciklama: string | null; durum: Durum; oncelik: Oncelik; kategori: string; atanan_kisi: string | null; son_tarih: string | null; hatirlatma_tarihi: string | null; created_at: string }
...
const emptyForm = { baslik: '', aciklama: '', durum: 'bekliyor' as Durum, oncelik: 'normal' as Oncelik, kategori: 'genel', atanan_kisi: '', son_tarih: '', hatirlatma_tarihi: '' }
...
export default function GorevlerModule({ firma }: AppCtx) {
  ...
  async function save() {
    ...
    setSaving(true)
    const payload = { baslik: form.baslik.trim(), aciklama: form.aciklama || null, durum: form.durum, oncelik: form.oncelik, kategori: form.kategori, atanan_kisi: form.atanan_kisi || null, son_tarih: form.son_tarih || null, hatirlatma_tarihi: form.hatirlatma_tarihi ? new Date(form.hatirlatma_tarihi).toISOString() : null, tamamlanma_tarihi: form.durum === 'tamamlandi' ? new Date().toISOString() : null, updated_at: new Date().toISOString() }
