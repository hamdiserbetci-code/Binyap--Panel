...
const defaultModules: ModuleConfig[] = [
  { id: 'genel-bakis', category: 'Operasyon', label: 'Maliyet Takibi', shortLabel: 'Maliyet Takibi', icon: LayoutGrid, accent: 'from-sky-500 to-cyan-400', title: 'Merkezi Operasyon Paneli', description: 'Sistemdeki aktif görevlerin, finansal yükümlülüklerin ve resmi süreçlerin konsolide özetini sunar.', allowedRoles: ['yonetici', 'muhasebe', 'santiye', 'izleme'] },
